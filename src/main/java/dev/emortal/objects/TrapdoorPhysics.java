...
public class TrapdoorPhysics implements MinecraftPhysicsObject {
    ...
    public TrapdoorPhysics(MinecraftPhysicsHandler physicsHandler, @Nullable PhysicsRigidBody parent, Instance instance, Vector3f size, float mass, Vector3f jointPos) {
        this.size = size;
